...
const ContactPage = () => {
  ...
  return (
    <section
      id="contact"
      className="h-full min-h-screen bg-[#354F52] px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48"
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 h-full">
        {/* LEFT SIDE - FORM */}
        <div className="flex items-center justify-center h-full">
          <form className="bg-[#CAD2C5] rounded-xl text-xl flex flex-col mt-10 gap-6 justify-center p-8 shadow-lg mx-auto">
